...
class DiTuyenSauDieuTriBase(SchemaBase):
    ...
    chan_doan_luc_di: str | None = Field(default=None, max_length=5000)
    ngay_ve: date | None = None
    chan_doan_luc_ve: str | None = Field(default=None, max_length=5000)
    ket_qua_huong_dieu_tri: str | None = Field(default=None, max_length=5000)
