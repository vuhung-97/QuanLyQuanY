        ...
        <Stack spacing={3}>
            ...
            <Grid container spacing={2.5}>
                <Grid size={{ xs: 12, md: 4 }}>
                    <Card sx={{ borderRadius: 3 }}>
                        <CardContent>
                            ...
                            <Typography color="text.secondary">Tổng tài khoản</Typography>
                        </CardContent>
                    </Card>
                </Grid>
                <Grid size={{ xs: 12, md: 4 }}>
                    <Card sx={{ borderRadius: 3 }}>
                        <CardContent>
                            <Typography variant="h3" color="success.main">{activeCount}</Typography>
                ...
                <Grid size={{ xs: 12, md: 4 }}>
                    <Card sx={{ borderRadius: 3 }}>
                        <CardContent>
                            <Typography variant="h3" color="primary.main">{roles.length}</Typography>
                            <Typography color="text.secondary">Vai trò khả dụng</Typography>
                        </CardContent>
                    </Card>
                </Grid>
            </Grid>
            ...
            <TableCard loading={loading}>
                ...
                ]} loading={false} emptyMessage="Không có tài khoản phù hợp." minWidth={760}>
            ...
            <UserFormDialog open={openDialog} onClose={() => setOpenDialog(false)}
                editingUser={editingUser} roles={roles} onSaved={handleDialogSaved} />

            <ConfirmDialog open={!!deleteTarget} title="Xác nhận xoá tài khoản"
                message={
                    <>Bạn có chắc muốn xoá tài khoản <strong>{deleteTarget?.ho_ten}</strong> ({deleteTarget?.ten_dang_nhap})? Hành động này không thể hoàn tác.</>
                }
                confirmLabel={deleting ? "Đang xoá..." : "Xoá"}
                confirmIcon={<DeleteIcon />} loading={deleting}
