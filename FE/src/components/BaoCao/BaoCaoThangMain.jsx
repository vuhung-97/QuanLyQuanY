    ...
    return (
        <Stack spacing={3}>
            ...
            <LoadingAlert
                ...
                error={error}
                empty={!data}
                emptyMessage="Chọn tháng/năm (hoặc Tất cả) và nhấn 'Tạo báo cáo' để xem dữ liệu."
            />
                ...
                <>
                    <Typography variant="h2" sx={{ color: "text.primary" }}>
                        {data.thang
                            ...
                            : `Báo cáo thống kê quân y năm ${data.nam}`
                        }
                    </Typography>
                    ...
                    <StatCardGrid
                        items={[
                            {
                                label: "Lượt khám",
                                value: data.tong_quan.tong_luot_kham,
                            ...
                            {
                                label: "Nội trú",
                                value: data.tong_quan.tong_noi_tru,
                                icon: <DomainIcon />,
                                color: "#3B82F6",
                            ...
                            {
                                label: "Chuyển tuyến",
                                value: data.tong_quan.tong_chuyen_tuyen,
                                icon: <HealingIcon />,
                                color: "#F59E0B",
                            ...
                            {
                                label: "Đơn thuốc",
                                value: data.tong_quan.tong_don_thuoc,
